...
TW_ENCLUDE_PYTHON := true
TW_ENCLUDE_NANO := true
...
TW_HAS_MTP := true
TW_DEVICE_VERSION := Build by Chinedu +2349039121780
TW_INCLUDE_INTERNAL_STORAGE := true
TW_INTERNAL_STORAGE_MOUNT_POINT := "/dev/block/platform/bootdevice/by-name/userdata"
TW_INCLUDE_DECRYPT_USERDATA := true
TW_HAS_USERDATA_PARTITION := true
